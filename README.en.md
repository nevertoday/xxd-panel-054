...
That frustration is why I made **Panel 054**. It does not press a template onto your image. It first works out what must not be lost, then translates it into **Split one memory into a main image and six unequal fragments**.
